...
(define tests
  (test-suite
   ...
   (check-equal? (vector-assoc 4 (vector (cons 4 "a") (cons 3 1) (cons 4 1) (cons 5 1))) (cons 4 "a") "vector-assoc test")
   (check-equal? (vector-assoc "a" (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons "a" "b"))) (cons "a" "b") "vector-assoc test")
   (check-equal? (vector-assoc "b" (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons "a" "b"))) #f "vector-assoc test")
